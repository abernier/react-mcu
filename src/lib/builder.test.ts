...
import darkFixture from "../fixtures/theme/Dark.tokens.json";
import lightFixture from "../fixtures/theme/Light.tokens.json";
...
describe("builder", () => {
  ...
  describe("toFigmaTokens()", () => {
    ...
    it("should match CLI-generated #6750A4 fixtures", () => {
      ...
      expect(result["Light.tokens.json"]).toEqual(lightFixture);
      expect(result["Dark.tokens.json"]).toEqual(darkFixture);
    });
