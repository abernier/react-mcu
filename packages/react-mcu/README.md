...
It injects `--md-sys-color-*` and `--md-ref-palette-*` CSS variables into the
page (prefix is [configurable](#programmatic-api)).
...
> `--md-sys-color-my-custom-color-1` /
> `--md-ref-palette-my-custom-color-1-<tone>`
