...
2. Extracts the primary color value
3. Generates a full MCU color palette using Material Color Utilities
...
- Uses the official [@material/material-color-utilities](https://github.com/material-foundation/material-color-utilities) library
